...
const steps = [
  {
    ...
    body: "Tell us which path best describes you and how you prefer to be contacted.",
  },
  {
    label: "We review the starting point",
    body: "We'll look into the most useful next step for you.",
  },
  {
    label: "Access opens with care",
    body: "When Natalyx is live, we can follow up with clearer guidance and support.",
  },
];
      ...
      <div className="mx-auto max-w-[1080px] px-6">
        <div className="mx-auto mb-11 max-w-[640px] text-center">
          <ScrollReveal>
            ...
            >
              A low-pressure path from interest to the right next conversation.
            </h2>
            <p className="mx-auto max-w-[640px] text-base leading-7 text-gray-500">
              Every public step stays lightweight until there is a private,
              appropriate reason to go deeper.
            </p>
          </ScrollReveal>
        </div>

        <div className="relative mx-auto grid max-w-[1000px] grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <ScrollReveal delay={280}>
          <div className="mx-auto mt-10 max-w-[720px] rounded-xl border border-dashed border-[#c7d2fe] bg-gradient-to-br from-primary/5 to-[#ec4899]/5 px-6 py-5 text-center text-sm leading-6 text-gray-600">
            Do not provide confidential medical, legal, or financial details
            with us yet.
          </div>
        </ScrollReveal>
      </div>
