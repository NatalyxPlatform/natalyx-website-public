export const ROLE_OPTIONS = [
  { value: "intended_parent", label: "I am looking to start or grow my family" },
  { value: "gestational_surrogate", label: "I am considering helping another family" },
...
export const JOURNEY_STAGE_OPTIONS = [
  ...
  { value: "have_clinic_or_lawyer", label: "I already have professional support" },
